...
df_summary_concentration1 <- df_final %>%
  group_by(condition) %>% 
  summarize(concentration = mean(concentration, na.rm = TRUE))

df_summary_concentration1
        
df_summary_enjoyment1 <- df_final %>%
  group_by(condition) %>% 
  summarize(enjoyment = mean(enjoyment, na.rm = TRUE))

df_summary_enjoyment1
